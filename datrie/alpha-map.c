...
/*
 * alpha-map.c - map between character codes and php-ext-datrie alphabet
 * Created: 2006-08-19
...
struct _AlphaMap {
    ...
    /* work area */
    /* alpha-to-php-ext-datrie map */
    AlphaChar  alpha_begin;
    AlphaChar  alpha_end;
    int        alpha_map_sz;
    TrieIndex *alpha_to_trie_map;

    /* php-ext-datrie-to-alpha map */
    int        trie_map_sz;
...
alpha_map_recalc_work_area (AlphaMap *alpha_map)
{
    ...
    if (range) {
        ...
        /* reconstruct alpha-to-php-ext-datrie map */
        ...
        /* reconstruct php-ext-datrie-to-alpha map */
